...
| TASK-039 | LINE (BE): bilingual TH/EN — `line-i18n` layer + per-user `lang` (default TH, seeded) + toggle + EN menu | SPEC-012 | **REVIEW** | Jason | TASK-038 |
