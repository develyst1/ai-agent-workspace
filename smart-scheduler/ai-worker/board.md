...
| REQ-007 | Freelance income-cap visible on the staff calendar (show + keep bookable) | MEDIUM | **READY_FOR_SA** | Sober — write SPEC (hub UC-016). **Queued behind the live hotfixes.** Reverses "hide over-cap" + reconciles backend confirm-block; over-cap = show color strip + still bookable, book past cap only via per-action override (คุณฟีน 2026-07-11). |
