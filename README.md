...
| `safe-goods` | ⚠️ **product not yet stated by the owner** — greenfield, three repos (`safe-goods-back`, `safe-goods-front`, `safe-goods-spec` = the owner's requirement repo). **MANUAL mode**, opened 2026-09-20 from `_templates/project`. Stack TBD (SPEC-001). | Porter (PM/BA/PO/UX writer), Sober (SA Lead), Jason (BE), Fern (FE), Tanya (QA) |
